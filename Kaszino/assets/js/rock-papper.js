...
window.onload = function(){
	...
	function win(userChoice, computerChoice){
		...
		userPick.value = convertToWord(userChoice);
		computerPick.value = convertToWord(computerChoice);
		winOrNot.value = 1;
	...
	function lose(userChoice, computerChoice){
		...
		computerPick.value = convetToWord(computerChoice);
		computerScore_span.innerHTML = convertToWord(computerScore);
		winOrNot.value = 0;
